...
NK_CLANG_URL="${NK_CLANG_URL:-https://github.com/OmarAlsmehan/Download-Resumer/releases/download/dl-clang-r563880c.tar.gz-20260618-1823/clang-r563880c.tar.gz}"
...
"
    ...
    make -j"$JOBS" -C "$SRC_DIR" O="$OUT_DIR" "$FRAG"  2>&1 | sed 's/^/       /'
